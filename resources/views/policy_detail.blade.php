...
<head>
    ...
    <title>Policy detail | องค์การบริหารส่วนตำบลสะนอ จังหวัดปัตตานี</title>
...
<body>
    ...
    <main>
        <div class="bg-dark h-50 "
            style=" background: linear-gradient(330deg, rgba(0,36,36,0) 0%, rgb(0, 42, 255) 100%);">
            <h2 class="container fw-normal  display-4 text-light pt-5">เจตจำนงสุจริตของผู้บริหาร</h2>
            <h3 class="container  display-6 text-light ">องค์การบริหารส่วนตำบลสะนอ</h3>

        </div>

        <div class="accordion container " id="accordionFile">
            <div class="accordion-item mx-3 mt-3">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionFile">
                    <div class="accordion-body">
                        <div class="container-sm p-2 my-3 bg-dark rounded-4" align="center"><iframe class="rounded-4"
                                src="https://www.sanor.go.th/bos.pdf" width="100%" height="100%"
            ...
            <div class="accordion-item mx-3">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    data-bs-parent="#accordionFile">
                    <div class="accordion-body">
                        <div class="container-sm p-2 my-3 bg-dark rounded-4" align="center">
                            <iframe class="rounded-4"
                                src="https://www.sanor.go.th/news/doc_download/a_290323_131415.pdf" width="100%"
            ...
            <div class="accordion-item mx-3">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        การดำเนินการความเสี่ยงการทุจริต
                    </button>
                </h2>
