...
<div>
        <div class="bg-body-secondary"
            ...
            <nav class="navbar navbar-expand-md  navbar-collapse  navbar-white shadow  bg-body-tertiary ">
                <!-- class="bg-color" -->
                ...
                <div class="container ">
                    ...
                    <button class="border-0 p-2 navbar-toggler" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false"
                        aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse   offcanvas px-4  px-lg-1 flex-row offcanvas-end  overflow-y-auto  d-block  w-75 bg-body-tertiary"
                        id="navbarCollapse">
                        ...
                        <ul class="navbar-nav  mb-2 mb-md-0">
                            ...
                            <li class="nav-item dropdown ">
                                <a class="nav-link c d-flex flex-wrap justify-content-between d-flex  fw-light py-1  "
                                    data-bs-toggle="collapse" href="#infoCollapse" aria-expanded="false"
                                    aria-controls="infoCollapse">
                                    <div>ข้อมูล อบต.</div>
                                    <div class="bi bi-chevron-down py-1"></div></span>
                                </a>
                        ...
                        <!-- Dropdown itme here -->
                        <ul class="collapse dropdown-menu   nav-dropdown nav-dropdown-default dropdown-uppercase"
                            style=" right:150px;">
                            <!-- 1 -->
                            <li class="nav-dropdown-col">
                        ...
                        <!-- start news/event -->
                        <li class="nav-item">
                            <a class="nav-link c  fw-light py-1  d-flex flex-wrap justify-content-between "
                                data-bs-toggle="collapse" href="#newsCollapse" aria-expanded="false"
                                aria-controls="newsCollapse">ข่าวสาร
                                <div class="bi bi-chevron-down py-1"></div>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link c d-flex flex-wrap justify-content-between fw-light py-1  d-flex "
                                data-bs-toggle="collapse" href="#docCollapse" aria-expanded="false"
                                aria-controls="docCollapse">เอกสาร/รายงาน <div class="bi bi-chevron-down py-1">
                                </div></a>
