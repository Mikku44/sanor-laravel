...
<body>
    ...
    <main>
        <div class="bg-dark h-50 "
            style=" background: linear-gradient(330deg, rgba(0,36,36,0) 0%, rgb(255, 179, 0) 100%);">
            <h2 class="container fw-normal  display-4 text-light pt-5">กิจกรรมและผลงาน</h2>
        ...
        <div class="container my-3">
            <h1>ปฏิทินกิจกรรมผู้บริหาร</h1>
            <!-- item1 -->
            <div class="row row-striped ">
                <div class="col-2 text-right ">
                    <h1 class="display-4"><span class="bg-black rounded-2 badge mx-2">10</span></h1>
                    <h2 class="mx-2">เมษายน</h2>
                </div>
                <div class="col-10">
                    <h3 class="text-uppercase"><strong>ประชุมคณะกรรมการ</strong></h3>
                    <ul class="list-inline">
                        <li class="list-inline-item"><i class="fa fa-calendar-o" aria-hidden="true"></i> Monday</li>
                        <li class="list-inline-item"><i class="fa fa-clock-o" aria-hidden="true"></i> 12:30 PM - 2:00 PM
                        </li>
                        <li class="list-inline-item"><i class="fa fa-location-arrow" aria-hidden="true"></i>สำนักงานเขต
                        </li>
                    </ul>
            ...
            <div class="row row-striped">
                <div class="col-2 text-right">
                    <h1 class="display-4"><span class="bg-black rounded-2 badge mx-2">13</span></h1>
                    <h2 class="mx-2">เมษายน</h2>
                </div>
                <div class="col-10">
                    <h3 class="text-uppercase"><strong>กิจกรรมอารีรายออิฎินฟิรตรี</strong></h3>
                    <ul class="list-inline">
