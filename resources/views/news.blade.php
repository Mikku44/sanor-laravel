...
<head>
    ...
    <title>ข่าวสาร | องค์การบริหารส่วนตำบลสะนอ จังหวัดปัตตานี</title>
    ...
    <link rel="icon" href="/docs/5.3/assets//public/img/favicons/favicon-32x32.png" sizes="32x32"
        type="image/png" />
    <link rel="icon" href="/docs/5.3/assets//public/img/favicons/favicon-16x16.png" sizes="16x16"
        type="image/png" />
...
<body>
    ...
    <main>
        ...
        <div class="bg-dark h-50 "
            style=" background: linear-gradient(330deg, rgba(0,36,36,0) 0%, rgb(255, 0, 170) 100%);">
            <h2 class="container fw-normal  display-4 text-light pt-5">ข่าวสาร</h2>
            <h3 class="container  display-6 text-light ">องค์การบริหารส่วนตำบลสะนอ</h3>
        </div>


        <!-- news2 -->
        <h1 align="center" id='content-title' class="mt-3">ข่าวจัดซื้อจัดจ้าง</h1>

        <!-- row -->
        <div class="row gap-3 my-3 justify-content-center">
            <!-- card-1 -->
