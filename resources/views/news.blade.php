...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="{{ URL::asset('/img/favicon.png') }}" sizes="180x180" />
    <link rel="icon" href="{{ URL::asset('/img/favicon.png') }}" sizes="32x32" type="image/png" />
    <link rel="icon" href="{{ URL::asset('/img/favicon.png') }}" sizes="16x16" type="image/png" />
...
<body>
    ...
    <main>
        ...
        <!-- news2 -->
        <h1 align="center" id='content-title' class="mt-3">{{ $title }}</h1>
    ...
    <footer class="m-0 p-2 px-5 text-white " style="background: rgb(153,153,153); ">
        ...
        <div class="d-flex flex-column align-items-center fw-light ">
            <img src="{{ URL::asset('img/logore.png') }}" width="80px" alt="">
