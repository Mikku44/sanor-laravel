...
<body>
    ...
    <main>
        <div class="bg-dark h-50 "
            style=" background: linear-gradient(330deg, rgba(0,36,36,0) 0%, rgb(255, 170, 0) 100%);">
            <h2 class="container fw-normal  display-4 text-light pt-5">แหล่งท่องเที่ยวชุมชน</h2>
