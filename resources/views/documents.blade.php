...
<head>
    ...
    <title>เอกสาร | องค์การบริหารส่วนตำบลสะนอ จังหวัดปัตตานี</title>
...
<body>
    ...
    <main>
        <div class="bg-dark h-50 "
            ...
            <h2 class="container fw-normal  display-4 text-light pt-5">เอกสารและรายงาน</h2>
        ...
        <div class="container mt-3">
            ...
            <a href="https://www.sanor.go.th/news/doc_download/a_170223_141047.pdf" target="_blank"
                ...
                <div class="btn w-100 card m-3  bg-body-tertiary" style="padding: 1vh;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="card-text d-flex align-items-center gap-3">
                            <div class="fa fa-file-pdf fs-1 text-danger"></div>

                            <div>
                                <div class="fs-5">เอกสารแผนพัฒนาท้องถิ่น</div>
                                <div class="fs-6 fw-light">อัปโหลดเมื่อ 19 ตุลาคม 2564
                                </div>
                            </div>
                        </div>
                ...
                <div class="btn w-100 card m-3  bg-body-tertiary" style="padding: 1vh;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="card-text d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="fs-5">เอกสารจัดซื้อ-จัดจ้าง</div>
                                <div class="fs-6 fw-light">อัปโหลดเมื่อ 19 ตุลาคม 2564
                                </div>
                            </div>
                        </div>
