...
<head>
    ...
    <title>กิจกรรม | องค์การบริหารส่วนตำบลสะนอ จังหวัดปัตตานี</title>
...
<body>
    ...
    <main>
        <div class="bg-dark h-50 "
            style=" background: linear-gradient(330deg, rgba(0,36,36,0) 0%, rgb(255, 0, 140) 100%);">
            <h2 class="container fw-normal  display-4 text-light pt-5">กฏหมายที่เกี่ยวข้อง</h2>
        ...
        <div class="container mt-3">
            ...
            <hr>
            <!-- file 1 -->
            <a href="https://www.sanor.go.th/news/doc_download/a_170222_105403.pdf" target="_blank"
                rel="noopener noreferrer">
                <div class=" w-100 card m-3  bg-body-tertiary" style="padding: 1vh;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="card-text d-flex align-items-center gap-3">
                            <div class="fa fa-file-pdf fs-1 text-danger"></div>

                            <div>
                                <div class="fs-5">
                                    พรบ.บำเหน็จบำนาญ ข้าราชการส่วนท้องถิ่น พศ 2556</div>
                                <div class="fs-6 fw-light">อัปโหลดเมื่อ 17 ก.พ. 2565
                                </div>
                            </div>
                        </div>

                        <div class="  p-2 fs-4 fa fa-arrow-up-right-from-square"></div>

                    </div>
                </div>
            </a>
            <!-- file 2 -->
            <a href="https://www.sanor.go.th/news/doc_download/a_170222_105500.pdf" target="_blank"
                rel="noopener noreferrer">
                <div class=" w-100 card m-3  bg-body-tertiary" style="padding: 1vh;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="card-text d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="fs-5">พรบ.ระเบียบบริหารงานบุคคลส่วนท้องถิ่น พศ.2542</div>
                                <div class="fs-6 fw-light">อัปโหลดเมื่อ 01 ธ.ค. 2564
                                </div>
                            </div>
                        </div>

                        <div class="btn  p-2 fs-4 fa fa-arrow-up-right-from-square"></div>

                    </div>
                </div>
            </a>
            <!-- file 3 -->
            <a href="https://www.sanor.go.th/news/doc_download/a_170222_105312.pdf" target="_blank"
                rel="noopener noreferrer">
                <div class=" w-100 card m-3  bg-body-tertiary" style="padding: 1vh;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div class="card-text d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="fs-5">
                                    ระเบียบสำนักนายกรัฐมนตรี ว่าด้วยการลาของข้าราชการ พศ.2555 </div>
                                <div class="fs-6 fw-light">อัปโหลดเมื่อ 28 ต.ค. 2564
                                </div>
                            </div>
                        </div>
